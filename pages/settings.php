<div class="mb-3">
    <h3><i class="bi bi-gear me-2 text-primary"></i>Settings</h3>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="card mb-3 animate__animated animate__fadeInLeft">
            <div class="card-header"><i class="bi bi-person-circle me-1"></i>Profile</div>
            <div class="card-body">
                <form>
                    <div class="mb-3">
        ...
        <div class="card mb-3 animate__animated animate__fadeInLeft">
            <div class="card-header"><i class="bi bi-translate me-1"></i>Language</div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card mb-3 animate__animated animate__fadeInRight">
            <div class="card-header"><i class="bi bi-info-circle me-1"></i>System Information</div>
            <div class="card-body">
